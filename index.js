...
const displayStr = `A total of $${totalContributions.toLocaleString(
  "en-US"
)} has been raised. Currently, ${unfundedGames.length} game${
  unfundedGames.length !== 1 ? "s" : ""
} remain${
  unfundedGames.length !== 1 ? "" : "s"
...
topImage.src = first.img;
topImage.alt = first.name;
topImage.style.width = "50%";
topImage.style.height = "50%";
firstGameContainer.appendChild(topGame);
firstGameContainer.appendChild(topImage);
...
runnerImage.src = second.img;
runnerImage.alt = second.name;
runnerImage.style.width = "50%";
runnerImage.style.height = "50%";
secondGameContainer.appendChild(runnerUp);
secondGameContainer.appendChild(runnerImage);
